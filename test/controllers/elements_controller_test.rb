...
class ElementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post elements_url, params: { element: { info: @element.info, slide_id: @element.slide_id } }
    end
  ...
  test "should update element" do
    patch element_url(@element), params: { element: { info: @element.info, slide_id: @element.slide_id } }
