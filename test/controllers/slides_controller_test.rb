...
class SlidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post slides_url, params: { slide: { presentation_id: @slide.presentation_id, title: @slide.title } }
    end
  ...
  test "should update slide" do
    patch slide_url(@slide), params: { slide: { presentation_id: @slide.presentation_id, title: @slide.title } }
